...
# input_jd_file_name = "amazon_sde1.json"
# input_jd_file_name = "openai_research_engg.json"
input_jd_file_name = "google_sre.json"


with open(f"tests/job_descriptions/{input_jd_file_name}", "r") as file:
